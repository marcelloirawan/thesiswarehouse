...
<div class="container-fluid">
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="<?= base_url('inventory/barang_keluar'); ?>">Barang Keluar</a></li>
		...
		<div class="col-lg-12">
			...
			<div class="card border-left-primary shadow">
				<div class="card-body">
					...
					<form action="<?= base_url('inventory/barang_keluar_submit'); ?>" method="post">
						...
						<div class="form-group">
							...
							<select name="id_customer" id="id_customer" class="form-control" required>
								...
								<?php foreach( $all_customer as $row_select ) : ?>
									<option value="<?= $row_select['id_customer']; ?>">
										<?= $row_select['nama']; ?>
									</option>
								<?php endforeach; ?>
							</select>
