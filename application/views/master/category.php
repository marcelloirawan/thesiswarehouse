...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<div>
			<a href="<?= base_url('master/category_add'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
						...
						<table class="table table-bordered text-nowrap" id="dataTable" width="100%" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a href="<?= base_url('master/category_edit/' . $row['id_category']); ?>" class="badge badge-primary">
											<i class="fas fa-fw fa-edit"></i>
											edit
										</a>
										<a href="#" class="badge badge-danger modalAjaxDelete" data-toggle="modal" data-target="#modalDelete" data-id="<?= $row['id_category']; ?>" data-category="<?= $row['category']; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url('master/category_delete'); ?>" method="post">

                    <!-- otomatis -->
                    <input type="text" name="ajaxDeleteIdCategory" id="ajaxDeleteIdCategory" value="" hidden>
                    <!-- end otomatis -->
