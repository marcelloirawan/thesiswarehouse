		...
		<div class="col-lg-12">
			...
			<div class="card border-left-primary shadow">
				<div class="card-body">
					...
					<form action="<?= base_url('master/category_update'); ?>" method="post">

						<!-- otomatis -->
						<input type="text" name="id_category" id="id_category" value="<?= $category_edit['id_category']; ?>" hidden>

						<div class="form-group">
							<label>Category</label>
							<input type="text" class="form-control" id="category" name="category" value="<?= $category_edit['category']; ?>" required>
						</div>

						<div class="form-group">
							<label>Remark</label>
							<input type="text" class="form-control" id="remark" name="remark" value="<?= $category_edit['remark']; ?>" required>
						</div>
