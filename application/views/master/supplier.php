...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<div>
			<a href="<?= base_url('master/supplier_add'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
				...
				<div class="card-body">
					...
					<div class="table-responsive">
						<table class="table table-bordered text-nowrap" id="dataTable" width="100%" cellspacing="0">
							...
							<tbody>
								<?php $no = 1; ?>
								<?php foreach( $all_supplier as $row ) : ?>
								<tr>
									...
									<td class="text-center">
										<a href="<?= base_url('master/supplier_edit/' . $row['id_supplier']); ?>" class="badge badge-primary">
											<i class="fas fa-fw fa-edit"></i>
											edit
										</a>
										<a href="#" class="badge badge-danger modalAjaxDelete" data-toggle="modal" data-target="#modalDelete" data-id="<?= $row['id_supplier']; ?>" data-supplier="<?= $row['supplier']; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url('master/supplier_delete'); ?>" method="post">

                    <!-- otomatis -->
                    <input type="text" name="ajaxDeleteIdSupplier" id="ajaxDeleteIdSupplier" value="" hidden>
                    <!-- end otomatis -->
