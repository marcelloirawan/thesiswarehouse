		...
		<div class="col-lg-12">
			...
			<div class="card border-left-primary shadow">
				<div class="card-body">
					...
					<form action="<?= base_url('admin/accounts_reset_password_update'); ?>" method="post">

						<!-- otomatis -->
						<input type="text" name="id_users" id="id_users" value="<?= $user_reset_password['id_users']; ?>" hidden>
